...
export default function Home() {
  return (
    <div className="min-h-screen bg-background relative w-full">
      ...
      {/* ── Hero ── */}
      <section id="home" className="container mx-auto px-4 py-10 sm:py-12 md:py-20 lg:py-28 scroll-mt-16">
        <div className="flex flex-col lg:flex-row items-center justify-start gap-6 lg:gap-16 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-4 sm:space-y-5 flex-1">
            <div className="space-y-2 animate-slide-in-right">
              ...
              <EditableText
                ...
                as="p"
                className="text-lg sm:text-xl md:text-3xl text-muted-foreground"
              />
            </div>

            <div className="flex flex-wrap gap-2 sm:gap-3 pt-2 justify-center lg:justify-start animate-fade-in-delay-3">
          ...
          {/* Photos */}
          <div className="flex-shrink-0 animate-fade-in mt-6 lg:mt-0">
            <div className="relative w-[240px] h-[300px] sm:w-[280px] sm:h-[340px] mx-auto lg:w-[400px] lg:h-[480px]">
              <div className="absolute left-0 top-0 w-28 h-28 sm:w-32 sm:h-32 lg:w-48 lg:h-48 rotate-[-8deg] hover:rotate-0 hover:scale-105 transition-all duration-300 z-10">
              ...
              <div className="absolute right-0 top-2 lg:top-8 w-28 h-28 sm:w-32 sm:h-32 lg:w-48 lg:h-48 rotate-[6deg] hover:rotate-0 hover:scale-105 transition-all duration-300 z-15">
                <div className="w-full h-full rounded-2xl overflow-hidden border border-border shadow-lg">
                  <Image src="/MirrorPic.jpg" alt="Tristan Yi" width={500} height={500} quality={95} className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="absolute left-2 lg:left-4 top-20 sm:top-24 lg:top-36 w-28 h-28 sm:w-32 sm:h-32 lg:w-48 lg:h-48 rotate-[4deg] hover:rotate-0 hover:scale-105 transition-all duration-300 z-20">
                <div className="w-full h-full rounded-2xl overflow-hidden border border-border shadow-lg">
                  <Image src="/Selfie.jpg" alt="Tristan Yi" width={500} height={500} quality={95} className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="absolute right-2 lg:right-4 top-24 sm:top-28 lg:top-44 w-28 h-28 sm:w-32 sm:h-32 lg:w-48 lg:h-48 rotate-[-5deg] hover:rotate-0 hover:scale-105 transition-all duration-300 z-25">
                <div className="w-full h-full rounded-2xl overflow-hidden border border-border shadow-lg">
      ...
      <section className="container mx-auto px-6 lg:px-10 pb-16 -mt-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap gap-x-4 gap-y-3 sm:gap-x-6 md:gap-x-10 sm:gap-y-4 justify-center lg:justify-start">
      ...
      <section id="projects" className="mx-auto px-4 sm:px-6 lg:px-10 py-12 sm:py-20 scroll-mt-16">
        <ProjectsSection />
      </section>
      </Reveal>
      ...
      <section id="music" className="mx-auto px-4 sm:px-6 lg:px-10 py-12 sm:py-20 scroll-mt-16">
        <div className="max-w-7xl mx-auto">
          <SpotifySection />
        </div>
      </section>
      ...
      {/* ── Hobbies ── */}
      <Reveal variant="fade-up" duration={900}>
      <section id="hobbies" className="mx-auto px-4 sm:px-6 lg:px-10 py-12 sm:py-20 scroll-mt-16">
        <div className="max-w-7xl mx-auto">
          <EditableText contentKey="section.hobbies.label" defaultValue="Beyond Code" as="p" className="text-sm sm:text-base uppercase tracking-[0.2em] text-muted-foreground/50 mb-2" />
          <EditableText contentKey="section.hobbies.title" defaultValue="Hobbies" as="h2" className="text-3xl sm:text-5xl md:text-6xl font-bold text-foreground mb-6 sm:mb-8" />
          <HobbiesSection />
        </div>
      </section>
      </Reveal>
      ...
      <section id="goals" className="mx-auto px-4 sm:px-6 lg:px-10 py-12 sm:py-20 scroll-mt-16">
        <div className="max-w-7xl mx-auto">
          <EditableText contentKey="section.goals.label" defaultValue="Looking Ahead" as="p" className="text-sm sm:text-base uppercase tracking-[0.2em] text-muted-foreground/50 mb-2" />
          <EditableText contentKey="section.goals.title" defaultValue="2026 Goals" as="h2" className="text-3xl sm:text-5xl md:text-6xl font-bold text-foreground mb-6 sm:mb-8" />
